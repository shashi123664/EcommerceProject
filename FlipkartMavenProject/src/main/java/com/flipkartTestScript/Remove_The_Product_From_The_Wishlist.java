...
public class Remove_The_Product_From_The_Wishlist extends BaseClass {

	@Test
	public void Remove_The_Product_From_The_Wishlist() throws Throwable {
		...
		Reporter.log("Product is successfully deleted from the wishlist", true);
